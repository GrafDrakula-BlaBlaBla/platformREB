...
@injectable()
export class WidgetIndustryRebAPIClient implements IWidgetIndustryAPIClient {
  ...
  getOKK = async (params?: Params): Promise<IIndustryDivisionOKKDTO> => {
    ...
    return this.APIModule.getData(
      `${this.urlPrefix}/reb/industrial-division/okk`,
      params
    );
  };
  ...
  getOKVED = async (params: Params): Promise<IIndustryDivisionOKVEDDTO> => {
    ...
    return this.APIModule.getData(
      `${this.urlPrefix}/reb/industrial-division/okved2`,
      params
    );
  };
}
